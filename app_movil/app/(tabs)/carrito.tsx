...
export default function CarritoScreen(){
    ...
    // funcon handleVaciarcarrito o sea pagar
    // muesra el dialogo de confirmacion de vaciar el carrito
     ...
     * style -> ocupa toeo el alto desdepende del celular ios andrid
